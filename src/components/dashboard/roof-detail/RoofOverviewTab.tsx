...
export function RoofOverviewTab({ roof, isEditing = false }: RoofOverviewTabProps) {
  ...
  return (
    <Tabs defaultValue="property-overview" className="w-full">
      <TabsList className="grid w-full grid-cols-2">
        <TabsTrigger value="property-overview">Property Overview</TabsTrigger>
        <TabsTrigger value="financial-summary">Financial Summary</TabsTrigger>
      </TabsList>
      
      <TabsContent value="property-overview" className="mt-6">
      ...
      <TabsContent value="financial-summary" className="mt-6">
