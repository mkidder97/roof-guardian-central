  ...
  public: {
    Tables: {
      ...
      inspection_capital_expenses: {
        ...
        Relationships: [
          {
            foreignKeyName: "fk_inspection_capital_expenses_inspection_id"
      ...
      inspection_deficiencies: {
        ...
        Relationships: [
          {
            foreignKeyName: "fk_inspection_deficiencies_inspection_id"
            columns: ["inspection_id"]
            isOneToOne: false
            referencedRelation: "inspections"
            referencedColumns: ["id"]
      ...
      inspection_photos: {
        ...
        Relationships: [
          {
            foreignKeyName: "fk_inspection_photos_inspection_id"
            columns: ["inspection_id"]
            isOneToOne: false
            referencedRelation: "inspections"
            referencedColumns: ["id"]
